...
def grant(
    ...
    url = f"{base_url}/subscribers/{requests.utils.quote(app_user_id)}/entitlements/{requests.utils.quote(entitlement_id)}/promotional"
    data = {}
...
def revoke(
    ...
    """
    base_url = API_ENDPOINTS["v1"][environment]
    url = f"{base_url}/subscribers/{requests.utils.quote(app_user_id)}/entitlements/{requests.utils.quote(entitlement_id)}/revoke_promotionals"
